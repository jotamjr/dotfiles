...
if awesome.startup_errors then
    naughty.notify({ preset = naughty.config.presets.critical,
                     title = "Oops, can't connect to the the matrix right now x_x!",
...
beautiful.init("~/.config/awesome/themes/mobiglass/theme.lua")
...
awful.screen.connect_for_each_screen(function(s)
   ...
   --                        awful.button({ }, 1, function () awful.layout.inc( 1) end),
    ...
    s.mywibox = awful.wibar({ position = "top", screen = s, height = 24, opacity = 0.9, border_width = 0})

    -- Spacer
    s.spacer2 = wibox.widget.textbox(" ")
    s.spacer = separators.arrow_right(beautiful.fg_normal,"alpha")
...
awful.rules.rules = {
    ...
    { rule = { },
      properties = { border_width = beautiful.border_width,
                     ...
                     -- urxvt issue with right and bottom gap
